...
{A_ACTOR}: Mas me promete que não vai falar que essas coisas são sobre mim?  
 
{PLAYER_ACTOR}: Prometo. Não precisa se preocupar!  
 
{A_ACTOR}: Sendo assim... tudo bem. 
...
{A_ACTOR}: Muito obrigado por vir até aqui e tentar me ajudar com isso.
{A_ACTOR}: Significa muito para mim, de verdade. 
 
{PLAYER_ACTOR}: Eu já disse que não precisa agradecer. 
{PLAYER_ACTOR}: Afinal nós somos amigos.